...
patch_vendor_cmdline "stock/vendor_boot.img" "tmpout" "out/vendor_boot" "${vendor_cmdline_to_add[@]}" 
cp stock/boot.img out/
cp patches/init_boot out/
...
mkfs.erofs -zlz4hc --ignore-mtime ./out/odm.img port/odm/
